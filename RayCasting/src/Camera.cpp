...
void Camera::GetViewFrustum()
{
	...
	//std::cout << "Near plane: TL : " << ntl.x << "," << ntl.y << "," << ntl.z << std::endl;
	//std::cout << "Near plane: TR : " << ntr.x << "," << ntr.y << "," << ntr.z << std::endl;
	//std::cout << "Near plane: BL : " << nbl.x << "," << nbl.y << "," << nbl.z << std::endl;
	//std::cout << "Near plane: BR : " << nbr.x << "," << nbr.y << "," << nbr.z << std::endl;
}
